...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        boolean isIncoming = chatMessage.AuthorUserId != Config.getUserId(parent.getContext());
        setAlignment(holder, isIncoming);
        holder.txtMessage.setText(chatMessage.Message);
        holder.txtInfo.setText(chatMessage.AuthorUserId + ": " + getTimeText(chatMessage));
    ...
    private String getTimeText(ChatMessage message) {
        ...
        return dateFormat.format(message.Date);
    }
